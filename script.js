...
//             bookList.innerHTML = "<tr><td colspan='7'>No books found.</td></tr>";
//         } else {
//             filteredBooks.forEach((book, index) => {
//                 const row = document.createElement("tr");

//                 const bookAge = calculateBookAge(book.pubDate);
...
//         bookList.innerHTML = "<tr><td colspan='7'>Failed to load books. Please try again later.</td></tr>";
//     }
// }

// // Calculate book age with edge case handling
...
//         return "Invalid Date"; // Handle future date case
//     }

//     const age = currentDate.getFullYear() - publicationDate.getFullYear();
//     return age === 0 ? "Less than a year old" : `${age} year(s) old`;
// }
